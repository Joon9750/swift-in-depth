...
filter 함수는 기존 컨테이너의 요소에서 조건에 만족하는 값에 대해서 새로운 컨테이너로 반환하기 때문에, 
...
for loop을 사용하다 보면 for loop과 함께 side effect가 발생하는 상황이 있습니다.
...
loop을 도는 횟수를 추적하고 싶을 때 enumerated 함수를 사용할 수 있습니다.
...
만약 increment가 10이 아니라 더 큰 값을 가진다면 iteration에 큰 비용이 들게 됩니다.
